...
export const useTodayStore = create<TodayState>()(
  persist(
    (set, get) => ({
      ...
      fetchTodayVisits: async (span: TodaySpan = get().span, showAll?: boolean) => {
      ...
      sortByDistance: async () => {
        ...
        const sorted = [...visits].sort((a, b) => {
          ...
          const aDist = haversine(loc.coords.latitude, loc.coords.longitude, a.client.latitude as number, a.client.longitude as number)
          const bDist = haversine(loc.coords.latitude, loc.coords.longitude, b.client.latitude as number, b.client.longitude as number)
          return aDist - bDist
        })

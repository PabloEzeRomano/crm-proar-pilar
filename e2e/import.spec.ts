...
test.describe('Excel Import (EP-023.3)', () => {
  ...
  test('should show "Importar datos" section with description', async ({
    page,
  }) => {
  ...
  test('should navigate to clients list and verify import', async ({
    page,
  }) => {
    ...
    const clientsLink = page
      .locator('text=/Clientes|Contactos/')
  ...
  test('should not create duplicate clients on second import', async ({
    page,
  }) => {
  ...
  test('should have accessibility labels for import button', async ({
    page,
  }) => {
    const importButton = page.locator('button:has-text("Seleccionar archivo")');
...
test.describe('Import Integration (EP-023.3)', () => {
  ...
  test('should handle Excel file with full data (dates, notes, contacts)', async ({
    page,
  }) => {
